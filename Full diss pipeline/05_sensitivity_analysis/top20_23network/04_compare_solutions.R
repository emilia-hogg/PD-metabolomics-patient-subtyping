...
branch_results_file <- file.path(branch_dir, "top20_23network_snf_results.rds")
...
prefix <- "top20_23network_vs_main_four_network"
...
message("Top-20 23-network comparison complete.")
