...
# representation_comparison branch vs saved main four-network solution
# Compares the 2-network representation branch to the main 4-network solution
# using the real outputs from 03_cluster_solution.R
# =========================================================
