...
# This script provides an overall comparison of each sensitivity-analysis
# cluster solution with the primary SNF solution. It summarises cluster
# agreement, the proportion of patients switching clusters, and overlap in
# switchers across sensitivity branches.
#
# Before running:
# - Set `project_root` to the local project directory.
# - The primary SNF solution must already exist.
# - Switcher tables for all sensitivity branches must already have been
#   generated by `05_cluster_switchers.R`.
#
# Outputs are saved under `paths$posthoc/compare_sensitivity_to_primary/`,
# including comparison summaries, contingency tables, switcher-overlap
# summaries, and plots.
